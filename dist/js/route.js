  ...
  function (_String) {
    ...
    _createClass(Router, [{
      ...
      value: function normalizeParams(params) {
        ...
        params = _typeof(params) !== 'object' ? [params] : params; // If passed Param is Observable Object [Vue]

        if (Object.keys(params).length < 1) return {}; // If the tags object contains an ID and there isn't an ID param in the
