...
var a = String.prototype.replace,
    ...
    S = function t(r, n, e, o, i, u, f, a, c, l, s, v, p, y) {
        ...
        for (var N = 0; N < k.length; ++N) {
            var T = k[N],
                F = "object" == typeof T && void 0 !== T.value ? T.value : h[T];
            if (!i || null !== F) {
                var D = g(h)
                    ? "function" == typeof e
                        ? e(n, T)
        ...
        if (t) {
            ...
            for (
                ...
                if (
                    ((c += 1),
                    !n.plainObjects &&
                        k.call(Object.prototype, u[1].slice(1, -1)) &&
                        !n.allowPrototypes)
                )
                    return;
                a.push(u[1]);
    ...
    D = function (t, r) {
        var n = (function (t) {
            ...
            return {
                ...
                delimiter:
                    "string" == typeof t.delimiter || d.isRegExp(t.delimiter)
                        ? t.delimiter
                        : C.delimiter,
                depth:
    ...
    A = /*#__PURE__*/ (function (t) {
        ...
        (i = t),
            ((e = u).prototype = Object.create(i.prototype)),
        ...
        return (
            ...
            (f.p = function () {
                ...
                return {
                    host:
                        null !=
                        (t = null == (r = this.t.location) ? void 0 : r.host)
                            ? t
                            : void 0 === f
                            ? ""
                            : f,
                    pathname:
                        null !=
                        (n =
                            null == (e = this.t.location) ? void 0 : e.pathname)
                            ? n
                            : void 0 === a
                            ? ""
                            : a,
                    search:
                        null !=
                        (o = null == (i = this.t.location) ? void 0 : i.search)
                            ? o
                            : void 0 === c
                            ? ""
                            : c,
