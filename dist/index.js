    ...
    var a = String.prototype.replace,
        ...
        k = function t(r, n, e, o, i, u, f, a, c, l, s, p, v, y) {
            ...
            if (
                ...
                if (o) return u && !v ? u(n, S.encoder, y, "key", s) : n;
                h = "";
            }
            if (
                "string" == typeof (d = h) ||
                ...
                if (u) {
                    var g = v ? n : u(n, S.encoder, y, "key", s);
                    if ("comma" === e && v) {
                        for (
                            var w = j.call(String(h), ","), E = "", R = 0;
                            R < w.length;
                            ++R
                        )
                            E +=
                                (0 === R ? "" : ",") +
                                p(u(w[R], S.encoder, y, "value", s));
                        return [p(g) + "=" + E];
                    }
                    return [p(g) + "=" + p(u(h, S.encoder, y, "value", s))];
                }
                ...
                if (!i || null !== D) {
                    var F = m(h)
                        ? "function" == typeof e
                            ...
                            : n
                        : n + (c ? "." + N : "[" + N + "]");
                    O(T, t(D, F, e, o, i, u, f, a, c, l, s, p, v, y));
                }
            }
            return T;
        },
        ...
        $ = function (t, r) {
            var n = (function (t) {
                ...
                return {
                    allowDots:
                        void 0 === t.allowDots ? C.allowDots : !!t.allowDots,
                    allowPrototypes:
                    ...
                    decoder:
                        "function" == typeof t.decoder ? t.decoder : C.decoder,
                    delimiter:
